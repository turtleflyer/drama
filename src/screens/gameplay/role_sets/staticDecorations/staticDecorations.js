...
export const customersTable = setImg(
  new Actor('div', customersTablePosition, { scaleF: stage.scaleF }).attachClassName('customersTable'),
  tableImg,
  { width: '100%' },
);

const postedSign = new Actor('div', objectivesParams.position, { scaleF: stage.scaleF }).attachClassName(
  'objectives',
);
